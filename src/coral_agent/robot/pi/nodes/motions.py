...
MOTIONS: Dict[str, Motion] = {
    ...
    "t-pose":     _single(T_POSE_PULSE, 1500),
    "dab":        _single(DAB_PULSE, 1500),
    "superhero":  _single(SUPERHERO_PULSE, 1500),
    "thinker":    _single(THINKER_PULSE, 1500),
    "muscles":    _single(MUSCLES_PULSE, 1500),
    "hand-raised": _single(HANDS_UP_PULSE, 1500),
    "warrior2":   _single(WARRIOR_PULSE, 1500),
}
